...
var documents = [{
    ...
    "body": "Econ 400: Intro to Applied Econometrics (Spring 2021): Canvas course site Course Instructor: Dr. Matthew Friedman Lecture: Online, asynchronous (available on Canvas) Travis's studentsZhuoli's students    TA: Travis Cao (travis. cao@wisc. edu) Discussion Sections:  Fridays, 9:55 - 10:45am Fridays, 11:00 - 11:50amOffice Hours:  Wednesdays, 2:30 - 3:30pm Thursdays, 4:15 - 5:15pm Or by appointmentHow to attend discussion sections and office hours online Discussion Materials:       Date   Content         Week 1 (1/29)   General Info; Get Started with Stata Handout   Dataset   Solution   Do-file   Recording       Week 2 (2/5)   Stats Review; More on Stata Handout   Dataset   Solution   Do-file   Recording Do-file for PS 1 Q2 (Travis’s approach for reference)       Week 3 (2/12)   Simple (Univariate) Linear Regression Handout   Dataset   Solution   Do-file   Recording Do-file for PS 2 Q1 (Travis’s approach for reference) Guide on solving PS 2 Q3       Week 4 (2/19)   Hypothesis Testing; Multivariate Linear Regression Handout   Solution   Do-file   Recording       Week 5 (2/26)   Nonlinear Regression; Dummy and Interaction Handout   Solution   Do-file   Recording Do-file for PS 4 Q4 (Travis’s approach for reference)       Week 6 (3/5)   BLUE; Homoskedasticity vs. Heteroskedasticity; Comparing Two Populations Handout (available by midnight of 3/4)       TA: Zhuoli Chen (zchen596@wisc. edu) Discussion Sections:  Fridays, 1:20 - 2:10pm Fridays, 2:25 - 3:15pmOffice Hours:  Mondays, noon - 1:00pm Wednesdays, noon - 1:00pm Or by appointmentHow to attend discussion sections and office hours online Discussion Materials:       Date   Content         Week 1 (1/29)   General Info; Get Started with Stata Handout   Dataset   Solution   Do-file   Recording       Week 2 (2/5)   Stats Review; More on Stata Handout   Dataset   Solution   Do-file   Recording       Week 3 (2/12)   Simple (Univariate) Linear Regression Handout   Dataset   Solution   Do-file   Recording       Week 4 (2/19)   Hypothesis Testing; Multivariate Linear Regression Handout   Solution   Do-file   Recording       Week 5 (2/26)   Nonlinear Regression; Dummy and Interaction Handout   Solution   Do-file   Recording       Week 6 (3/5)   BLUE; Homoskedasticity vs. Heteroskedasticity; Comparing Two Populations Handout (available by midnight of 3/4)     "
    }];
