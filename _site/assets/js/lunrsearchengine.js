...
var documents = [{
    ...
    "body": "Econ 400: Intro to Applied Econometrics (Spring 2021): Canvas course site Course Instructor: Matt Friedman Lecture: Online, asynchronous (available on Canvas) Travis's studentsZhuoli's students    TA: Travis Cao (travis. cao@wisc. edu) Discussion Sections:  Fridays, 9:55 - 10:45am Fridays, 11:00 - 11:50amOffice Hours:  Wednesdays, 2:30 - 3:30pm Thursdays, 4:15 - 5:15pm Or by appointmentHow to attend discussion sections and office hours online Discussion Handouts:       Date   Content         Week 1 (1/29)   General Info; Get Started with Stata Handout   Dataset   Solution   Do-file   Recording       TA: Zhuoli Chen (zchen596@wisc. edu) Discussion Sections:  Fridays, 1:20 - 2:10pm Fridays, 2:25 - 3:15pmOffice Hours:  Mondays, noon - 1:00pm Wednesdays, noon - 1:00pm Or by appointmentHow to attend discussion sections and office hours online Discussion Handouts:       Date   Content         Week 1 (1/29)   General Info; Get Started with Stata Handout   Dataset   Solution   Do-file   Recording     "
    }];
